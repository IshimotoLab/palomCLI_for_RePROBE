...
psr.add_argument('-f', '--folderPath', required=True, help=r'Path to the directory where your image files are stored (example: /home/ishimotolab/workspace/palom_data)')
psr.add_argument('-r', '--refName', required=True, help=r'File name for reference image  (example: samplename_DNA1_Pan-CK_aSMA.ome.tif)')
